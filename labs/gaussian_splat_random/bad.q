...
.set tile_x, ra3
.set tile_y_16, ra4  # stores 16 * tile_y
...
.macro render_tile
    ...
    :1
        ...
        itof px, x; ldtmu0
        mov cur_cov2d_inv_x, r4; ldtmu0
        mov cur_cov2d_inv_y, r4; mov y, tile_y_16  # reset y to tile_y * TILE_SIZE
        ...
        ldtmu0
        mov cur_cov2d_inv_z, r4; ldtmu0
        mov cur_opacity, r4

        ldtmu1
        mov cur_screen_x, r4; ldtmu1
        mov cur_screen_y, r4; ldtmu1
        mov cur_color_r, r4; ldtmu0
        mov cur_color_g, r4; ldtmu0
        mov cur_color_b, r4

        # px actually holds dx
...
.if 0
        .rep row, 16
            ...
            fmul r2, r3, out_r
            fadd r1, r1, r2; fmul r2, cur_color_g, r0  # start calculating out_g
            mov.pack8csf pixel_buffer+row, r1  # converts [0.0, 1.0] to [0, 255] in bit 2

            # calc out_g
            fmul r1, r3, out_g
            fadd r1, r1, r2; fmul r2, cur_color_b, r0  # start calculating out_b
            mov.pack8bsf pixel_buffer+row, r1  # same op as above in bit 1

            # calc out_b
            fmul r1, r3, out_b
            fadd r1, r1, r2; mov r0, px  # move dx back into r0
